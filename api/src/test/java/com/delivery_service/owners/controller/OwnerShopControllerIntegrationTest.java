...
class OwnerShopControllerIntegrationTest {
    ...
    void addShop() {
        ...
        ResponseEntity<CommonResponse<ShopInfoDto>> addShopResult = testRestTemplate.withBasicAuth(TYPE_OWNER, ownerId)
                .exchange("/owners/shops", HttpMethod.POST, addShopRequest, new ParameterizedTypeReference<CommonResponse<ShopInfoDto>>() {});
    ...
    void getShop() {
        ...
        ResponseEntity<CommonResponse<ShopInfoDto>> getShopResult = testRestTemplate.withBasicAuth(TYPE_OWNER, ownerId)
                .exchange("/owners/shops", HttpMethod.GET, getShopRequest, new ParameterizedTypeReference<CommonResponse<ShopInfoDto>>() {
                });
    ...
    void updateShop() {
        ...
        ResponseEntity<CommonResponse<ShopInfoDto>> updateShopResult = testRestTemplate.withBasicAuth(TYPE_OWNER, ownerId)
                .exchange("/owners/shops", HttpMethod.PUT, updateShopRequest, new ParameterizedTypeReference<CommonResponse<ShopInfoDto>>() {});
    ...
    void updateShopStatus() {
        ...
        ResponseEntity<CommonResponse<ShopStatusDto>> updateShopResult = testRestTemplate.withBasicAuth(TYPE_OWNER, ownerId)
                .exchange("/owners/shops/status", HttpMethod.PATCH, updateShopStatusRequest, new ParameterizedTypeReference<CommonResponse<ShopStatusDto>>() {});
